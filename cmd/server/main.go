...
func main() {
	...
	adminPassword, err := utils.InitializeDefaultAdmin(ctx, repos.User)
	if err != nil {
		log.Printf("Warning: Failed to initialize default admin: %v", err)
	} else if adminPassword != "" {
		// Admin was created, print credentials
		log.Println("================================================================================")
		...
		log.Println("================================================================================")
		log.Println("IMPORTANT: Save these credentials! They will not be shown again.")
		log.Println("           Change the password immediately after first login.")
		log.Println("================================================================================")
	}
